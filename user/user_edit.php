...
$role = $_SESSION['ROLE'];
if ( $role !== "admin"){
    printf("<script>location.href='user_profile.php'</script>");
}else{
 ...
 ?>
		<div class="main">
			<div class="main-content" id="container">
				...
				<hr/>
				<form id="registration_form" action="user_update.php?id=<?php echo $id;?>" method="POST" enctype="multipart/form-data" >
					<div class="form-row">
						<div class="form-group col-md-12">
					     	<input type="text" class="form-control" id="form_name" name="name" value="<?php echo $row['NAME']; ?>"  required>
					     	<label>Name</label>
					     	<p class="error_form" ic="name_error_massage"></p>
						</div>
					    <div class="form-group col-md-12">
					      	<input  type="email" class="form-control" id="form_email" name="email" value="<?php echo $row['EMAIL']; ?>" required>
					      	<label>Email</label>
                  ...
                  -->
					    <div class="form-group col-md-12">
					      ...
					      <input type="text" class="form-control" id="form_address" name="address" value="<?php echo $row['P_Address']; ?>" required>
					      <label>Parmanent Address</label>
					    </div>
					    <div class="form-group col-md-3">
					    	<span class="error_form" ic="mobile_error_massage"></span>
					      	<input type="text" class="form-control" id="form_mobile" name="mobile" value="<?php echo $row['MOBILE']; ?>" required>
					  	...
					  	<div class="form-group col-md-4">
					      	<input style="border: none;" type="file" name="file" accept=".jpg,.jpeg,.png" >
					  ...
					  <div class="form-group col-md-12">
					     <button type="submit" class="btn-lg btn btn-primary">Edit User</button>
					  </div>
				</form>
			</div>
		</div>
